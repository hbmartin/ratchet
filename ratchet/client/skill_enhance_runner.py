# ratchet/client/skill_enhance_runner.py
...
Usage::
    ...
    python -m ratchet.client.skill_enhance_runner \\
        --test-cases /tmp/ratchet-eval-tests.json \\
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="ratchet.client.skill_enhance_runner",
