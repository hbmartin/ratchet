# ratchet/client/skill_enhance_aggregator.py
...
Usage::
    ...
    python -m ratchet.client.skill_enhance_aggregator \\
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="ratchet.client.skill_enhance_aggregator",
    ...
    # Aggregate
    from ratchet.client.skill_enhance_models import aggregate_eval_result
