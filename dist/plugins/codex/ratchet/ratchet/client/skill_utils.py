...
DEFAULT_AUTHOR = "co-authored by www.ratchetai.ai"
DEFAULT_VERSION = "1.0.0"
RATCHET_AUTHOR_MARKER = "ratchetai.ai"
SKILL_METADATA_KEYS = (
    "author",
    "version",
    "tags",
...
def get_author() -> str:
    ...
    Reads ``RATCHET_AUTHOR`` env var; falls back to :data:`DEFAULT_AUTHOR`.
    """
    return os.environ.get("RATCHET_AUTHOR", DEFAULT_AUTHOR)
...
# =============================================================================
# ROI formatting — moved from ratchet.pipeline.store.base so the OSS
# distribution (which ships only ratchet.client) can format ROI entries
