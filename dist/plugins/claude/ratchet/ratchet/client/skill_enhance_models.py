# ratchet/client/skill_enhance_models.py
"""Pydantic models and verdict logic for skill-enhance evaluation.

Canonical location — previously lived in ``ratchet.pipeline.skill_enhance``
...
EVAL_LIFT_THRESHOLD = max(
    0.0, min(1.0, float(os.getenv("RATCHET_BEHAVIORAL_LIFT_THRESHOLD", "0.05")))
)
EVAL_SAVINGS_THRESHOLD = max(
    0.0, min(1.0, float(os.getenv("RATCHET_BEHAVIORAL_SAVINGS_THRESHOLD", "0.2")))
)
