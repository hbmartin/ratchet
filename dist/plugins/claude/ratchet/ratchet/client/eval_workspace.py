# ratchet/client/eval_workspace.py
...
Directory structure::
    ...
    ~/.local/ratchet/data/skill-enhance/{skill-name}/
      iteration-1/
...
from ratchet.client.skill_utils import canonical_skill_name
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="ratchet.client.eval_workspace",
